...
driver.get('http://gcjs.gzzbtbzx.com:88/zbgg/more_ze.asp?keyword=&dq=4&cut=&page=1')
...
locator = (By.XPATH, '//td[@bgcolor="#DFDFDF"]/table[2]/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[4]/td/a[not(contains(string(),"%s"))]'%val)
WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator))

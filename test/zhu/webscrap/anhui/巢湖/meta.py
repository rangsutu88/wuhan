...
data=[
    ...
    ["gcjs_biaoqian_gg","http://www.hfggzy.com/chzbtb//showinfo/moreinfolist.aspx?categorynum=003001004&Paging=1",[  'name', 'ggstart_time', 'href','info'],f4,f5],
    ...
    ["chouqian_zhaobiao_gg","http://www.hfggzy.com/chzbtb/jyxx/003004/003004001/?Paging=1",[  'name', 'ggstart_time', 'href','info'],f1,f2],
    ["chouqian_dayibiangeng_gg","http://www.hfggzy.com/chzbtb/jyxx/003004/003004002/?Paging=1",[  'name', 'ggstart_time', 'href','info'],f1,f2],
    ["chouqian_zhongbiaohx_gg","http://www.hfggzy.com/chzbtb/jyxx/003004/003004003/?Paging=1",[  'name', 'ggstart_time', 'href','info'],f1,f2],
    ["chouqian_zhongbiao_gg","http://www.hfggzy.com/chzbtb/jyxx/003004/003004004/?Paging=1",[  'name', 'ggstart_time', 'href','info'],f1,f2],

]

def work(conp):
    gg_meta(conp,data=data,diqu="安徽省巢湖市")

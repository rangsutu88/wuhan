...
def f1(driver,num):
    ...
    if num !=1:
        val=driver.find_element_by_xpath('//table[@class="ewb-info-table"]/tbody/tr[1]/td[2]/a').text
        ...
        locator = (By.XPATH, '//table[@class="ewb-info-table"]/tbody/tr[1]/td[2]/a[not(contains(string(),"%s"))]' % val)
        WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator))
...
data=[
    ...
    ["gcjs_zhongbiao_gg","http://www.qhggzyjy.gov.cn/ggzy/jyxx/001001/001001006/secondPage.html",[ "name", "href", 'address',"ggstart_time","info"],f1,f2],

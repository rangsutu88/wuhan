...
def f2(driver):
    ...
    for i in range(1, all_more + 1):
        ...
        try:
            ...
            total_ = 0
        cc_text = driver.find_element_by_xpath('//*[@id="right"]/div[1]/div/span').text
...
data=[
  ...
  # # #包含变更和变更中标人，中标候选人
   ...
   ### #包含变更和变更中标人，中标候选人
    ["gcjs_shuili_gg","http://jyzx.fy.gov.cn/FuYang/slgc/014003/014003001/",["name","ggstart_time","href","info"],f1,f2],
  ...
  ###  #包含流标，变更
    ["qsy_gg","http://jyzx.fy.gov.cn/FuYang/shfw/017003/017003001/",["name","ggstart_time","href","info"],f1,f2],
...
if __name__=='__main__':
    ...
    work(conp=["postgres","since2015","192.168.3.171","anhui","fuyang"],cdc_total=None)
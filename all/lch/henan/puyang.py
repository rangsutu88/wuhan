...
data = [
    ...
    ##包含中标,流标
    ["zfcg_zhong_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=0102&bz=1&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],

    ##包含变更,流标
    ["zfcg_bian_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=0103&bz=1&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],

    ["zfcg_danyilaiyuan_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=1301&bz=0&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],

    ["zfcg_jinkou_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=1302&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],
    ["zfcg_qita2_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=1303&bz=0&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],

    ["zfcg_qita_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=1304&bz=0&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],
     ...
     ["zfcg_jingjia_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=1201&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],

    ["zfcg_xieyi_gg", "http://puyang.hngp.gov.cn/puyang/ggcx?appCode=H70&channelCode=1009&pageSize=20&pageNo=1",["name","ggstart_time", "href", 'info'], f1, f2],

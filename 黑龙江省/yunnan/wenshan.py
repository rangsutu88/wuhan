...
data=[
    #
    ["gcjs_zhaobiao_gg","http://wsggzy.cn/jyxx/jsgcZbgg",["index_num", "name", "href", "ggstart_time", "ggend_time","info"],f1,f2],
    ["zfcg_zhaobiao_gg","http://wsggzy.cn/jyxx/zfcg/cggg",["index_num", "name", "href", "ggstart_time", "ggend_time","info"],f1,f2],

    ["gcjs_biangengdayi_gg","http://wsggzy.cn/jyxx/jsgcBgtz",["index_num", 'title',"name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_zhongbiaohx_gg","http://wsggzy.cn/jyxx/jsgcpbjggs",["index_num", "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_zhongbiao_gg","http://wsggzy.cn/jyxx/jsgcZbjggs",["index_num", "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_liubiao_gg","http://wsggzy.cn/jyxx/jsgcZbyc",["index_num", "name", "href", "yctype","ggstart_time","info"],f1,f2],
    ["zfcg_liubiao_gg","http://wsggzy.cn/jyxx/zfcg/zfcgYcgg",["index_num", "name", "href", "yctype","ggstart_time","info"],f1,f2],

    ["zfcg_biangengdayi_gg","http://wsggzy.cn/jyxx/zfcg/gzsx",["index_num", "name", "href", "ggstart_time","info"],f1,f2],
    ["zfcg_zhongbiao_gg","http://wsggzy.cn/jyxx/zfcg/zbjggs",["index_num", "name", "href", "ggstart_time","info"],f1,f2],


]

def work(conp,**args):
    est_meta(conp,data=data,diqu="云南省文山市",**args)
    est_html(conp,f=f3,**args)


if __name__=='__main__':

    conp=["postgres","since2015","192.168.3.171","yunnan","wenshan"]
